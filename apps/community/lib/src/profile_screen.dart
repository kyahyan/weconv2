...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _pickAndUploadImage() async {
    ...
    try {
      ...
      // We need to update the profile model locally with the new URL
      // And then save the whole profile to DB to be consistent
      // But _saveProfile takes form arguments.
